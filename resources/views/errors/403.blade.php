...
<style>
    ...
    .error-icon { width: 72px; height: 72px; background: rgba(239,68,68,.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 2rem; color: #ef4444; margin: 0 auto 16px; }
...
<div class="error-card">
    ...
    <h5>Akses Ditolak</h5>
    <p>Anda tidak memiliki izin untuk mengakses halaman ini. Silakan hubungi administrator.</p>
